...
// import 'package:dream_carz/presentation/blocs/delete_account_bloc/delete_account_bloc.dart';
          ...
          builder: (BuildContext dialogContext) {
            return AlertDialog(
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // Close dialog first, then trigger the event
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Mobile Number (disabled/readonly)
                      _buildTextField(
                        controller: _numberController,
                        label: "Mobile Number",
                        prefixIcon: Icons.phone_outlined,
                      ...
                      Container(
                        ...
                        child: BlocConsumer<DeleteAccountBloc,
                            DeleteAccountState>(
                          listener: (context, state) {
                            if (state is DeleteAccountSuccessState) {
                              CustomSnackbar.show(
                          ...
                          builder: (context, state) {
                            bool isLoading = state is DeleteAccountLoadingState;
                              ...
                              onPressed: isLoading
                                  ...
                                  : () async {
                                      ...
                                      if (_formKey.currentState!.validate()) {
                                        ...
                                        // If confirmed, trigger the delete event
